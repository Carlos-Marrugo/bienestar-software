...
public class ActividadEstudianteDto {
    ...
    private ActividadInstructorDto.UbicacionSimpleDto ubicacion;
    private LocalDate fechaInicio;
    private LocalDate fechaFin;
    private Integer maxEstudiantes;
    private List<ActividadInstructorDto.HorarioAsignadoDto> horariosAsignados;
    ...
    public ActividadEstudianteDto(Actividad actividad) {
        this.id = actividad.getId();
        this.nombre = actividad.getNombre();
        this.ubicacion = new ActividadInstructorDto.UbicacionSimpleDto(actividad.getUbicacion());
        ...
        this.horariosAsignados = actividad.getHorariosEspecificos().stream()
                .map(ActividadInstructorDto.HorarioAsignadoDto::new)
